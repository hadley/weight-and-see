...
\title*{Weight and See}
\author{
Antony Unwin\inst{1}, Heike Hofmann\inst{2}  \and Hadley Wickham\inst{3}
}
\institute{
Augsburg University, Germany \texttt{unwin@math.uni-augsburg.de}\and Iowa State University, USA \texttt{hofmann@iastate.edu}\and Rice University, USA \texttt{h.wickham@gmail.com}
}
...
\begin{center}
      \includegraphics[width=8cm]{Berk.pdf}
...
\begin{center}
      \includegraphics[width=10cm]{Blackhists2.pdf}
...
\begin{center}
      \includegraphics[width=10cm]{florbub.pdf}
